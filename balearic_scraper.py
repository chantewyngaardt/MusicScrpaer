...
GENRE_KEYWORD = "balearic"
SAVE_DIR = "Balearic"
MAX_TRACKS = 1000

EXCLUDE_PLAYLIST_KEYWORDS = [
    "classical", "lofi", "lo-fi", "study", "sleep", "piano", "guitar", "acoustic", "ambient",
    "sad", "emotional", "tiktok", "throwback", "retro", "vintage",
    "k-pop", "trap", "hip hop", "rap", "drill", "r&b", "afro", "amapiano",
    "rock", "metal", "dubstep", "edm", "house", "club", "techno", "dancehall",
    "explicit", "dirty", "live", "old", "elevator", "smooth vibes"
]
...
EXPLICIT_TITLE_BLOCKLIST = [
    ...
    "live", "karaoke", "instrumental", "remix", "cover",
    "performance", "edit", "mix", "dj set", "session",
    "beats", "lofi", "sad", "emotional", "elevator"
]
