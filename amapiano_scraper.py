...
GENRE_KEYWORD = "amapiano"  # 👈 Focused genre search
SAVE_DIR = "Amapiano"
MAX_TRACKS = 1000

EXCLUDE_PLAYLIST_KEYWORDS = [
    "afrobeat", "afrobeats", "gqom", "kwaito", "house", "techno", "edm", "deep house", "club", "trap",
    "hip hop", "rap", "k-pop", "r&b", "pop", "rock", "metal", "jazz", "lofi", "study", "sleep", "throwback",
    "old school", "instrumental", "live", "karaoke", "remix", "dubstep", "tiktok", "classical", "sad",
    "emotional", "elevator", "piano chill", "covers", "indie"
]
