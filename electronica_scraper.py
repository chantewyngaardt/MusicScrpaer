...
GENRE_KEYWORD = "electronica"
SAVE_DIR = "Electronica"
MAX_TRACKS = 1000

EXCLUDE_PLAYLIST_KEYWORDS = [
    "lofi", "sleep", "study", "classical", "jazz", "afro", "amapiano", "throwback",
    "oldies", "rock", "metal", "indie", "rap", "hip hop", "k-pop", "r&b", "trap", "reggae"
]
