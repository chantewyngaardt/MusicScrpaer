...
GENRE_KEYWORD = "80s classics"  # 👈 Focused genre search
SAVE_DIR = "80s Classics"
...
def try_download(track_name: str, artist_name: str, is_explicit: bool):
    ...
    # yt-dlp opts: use Chrome cookies (your old working method) + hardening
    ydl_opts = {
        'format': 'bestaudio[ext=m4a]/bestaudio/best',
        'outtmpl': f"{SAVE_DIR}/{filename_base}.%(ext)s",
        'noplaylist': True,
        'default_search': 'ytsearch25',
        'cookiesfrombrowser': ('chrome',),   # <<—— your old method
        'quiet': True,
        'no_warnings': True,
        'retries': 15,
        'fragment_retries': 15,
